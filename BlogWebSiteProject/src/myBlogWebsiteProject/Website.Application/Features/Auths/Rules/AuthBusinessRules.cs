...
namespace Website.Application.Features.Auths.Rules
{
    public class AuthBusinessRules : BaseBusinessRules
    {
        ...
        public async Task UserPasswordShouldBeMatched(int id, string password)
        {
        ...
        public Task OtpAuthenticaticatorShouldBeExists(OtpAuthenticator? otpAuthenticator)
        {
        ...
        {
            if (otpAuthenticator is not null && otpAuthenticator.IsVerified) throw new BusinessException(AuthMessages.AlreadyVerifiedOtpAuthenticatorIsExists);
            return Task.CompletedTask;
        }
    }
}
